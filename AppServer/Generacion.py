...
class Generacion:
    ...
    def generar(self, porcentaje):
        ...
        self.mejor_usac = sorted(self.modelos_usac, key= lambda item: item.train_accuracy, reverse=True)
        self.mejor_marroquin = sorted(self.modelos_marroquin, key= lambda item: item.train_accuracy, reverse=True)
        self.mejor_mariano = sorted(self.modelos_mariano, key= lambda item: item.train_accuracy, reverse=True)
        self.mejor_landivar = sorted(self.modelos_landivar, key= lambda item: item.train_accuracy, reverse=True)
